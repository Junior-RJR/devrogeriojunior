        ...
        <div className="servicos">
            ...
            <div className="grid-container">
                <div className="servico">
                    ...
                    <p>Realizamos a criação, manutenção e limpeza e reparação no código em diversos sites, tais como da btrefinish, bellacor, PVT Consultoria<br/> e muito mais.</p>
                </div>
                <div className="servico">
